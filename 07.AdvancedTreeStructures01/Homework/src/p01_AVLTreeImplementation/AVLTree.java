...
//        node.setBalanceFactor(node.getBalanceFactor() - 1 - Math.max(parent.getBalanceFactor(), 0));
//        if (rightChildOfTheNode != null) {
//            rightChildOfTheNode.setBalanceFactor(rightChildOfTheNode.getBalanceFactor() - 1 + Math.min(rightChildOfTheNode.getBalanceFactor(), 0));
//        }
    }
    ...
    private void rightRightRotation(Node<T> node) {
        ...
        node.setBalanceFactor(0);
//        node.setBalanceFactor(node.getBalanceFactor() + 1 - Math.max(parentOfTheNode.getBalanceFactor(), 0));
        parentOfTheNode.setBalanceFactor(0);
//        if (leftChildOfTheNode != null) {
//            leftChildOfTheNode.setBalanceFactor(leftChildOfTheNode.getBalanceFactor() + 1 + Math.min(leftChildOfTheNode.getBalanceFactor(), 0));
//        }
    }
